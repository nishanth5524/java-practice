...
public class HDFC extends Tax_Calc {
    ...
    HDFC() {
        ...
        System.out.println("Total HDFC COUNT: " + Hcount);
        while (true) {
            ...
            if (n == 1) {
                ...
                Proof_of_income obj = ob1.Credit(h_min_sal,7000+Hcount);
                Hcount++;
                v.add(obj);
     ...
     public static void Hdfc_signin() {
        try {
            Scanner sc = new Scanner(System.in);
    ...
    public static void Hdfc_signup() {
