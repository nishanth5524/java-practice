...
class Demo09 extends JFrame implements ActionListener
{  
 ...
 Demo09()  
  ...
  public void actionPerformed(ActionEvent ae){
        ...
        if(obj_source==b1){
           ...
           if(!(Qarea.getText().isEmpty()&&A1.getText().isEmpty()&&A2.getText().isEmpty()&&A3.getText().isEmpty()&&A4.getText().isEmpty()&&tf.getText().isEmpty()))
